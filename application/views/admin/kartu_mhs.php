		...
		<div class="col-xl col-lg">
			<div class="card shadow mb-4">
				...
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					<a href="<?= site_url('admin/laporan'); ?>" class="btn btn-secondary btn-sm"><i class="fas fa-xs fa-angle-left"></i> Kembali</a>
					<a class="btn btn-success btn-sm" href="<?= site_url('admin/unduh_kartu/') . $duser['id']; ?>"><i class="fas fa-xs fa-file-pdf"></i>
						Unduh</a>
				</div>
				<!-- Card Body -->
				<div class="card-body">
					...
					<div class="my-4">
						<div class="row">
							...
							<div class="col">
								<p class="text-muted">: <?= $duser['nama']; ?></p>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-1">
							...
							<div class="col">
								<p class="text-muted">: <?= $duser['nim']; ?></p>
							</div>
						</div>
						<div class="row">
							<div class="col-sm-1">
						...
						<table class="table table-bordered table-responsive">
							...
							<tbody>
								...
								<?php
									...
									echo '<tr>
									<td class="text-center" colspan="6"><small class="text-danger">Mahasiswa bersangkutan belum pernah menghadiri seminar proposal</small></td>
								</tr>';
								}
								?>
							</tbody>
